...
public class FilesService {	
	...
	public WebResponseStatus uploadFiles (String destinationPath, CommonsMultipartFile file) {
		WebResponseStatus responseStatus = new WebResponseStatus();
	...
	public WebResponseStatus deleteFiles (String originPath, String filename) {
		WebResponseStatus responseStatus = new WebResponseStatus();
		responseStatus.setValid(true);
