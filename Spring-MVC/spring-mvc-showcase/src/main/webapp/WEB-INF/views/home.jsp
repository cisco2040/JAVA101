...
<div id="tabs">
    ...
    <div id="simple">
		<h2>Simple</h2>
		<p>
			See the <code>com.softtek.samples.mvc.simple</code> package for the @Controller code
		</p>
		<ul>
			<li>
	...
	<div id="mapping">
		...
		<p>
			See the <code>com.softtek.samples.mvc.mapping</code> package for the @Controller code
		</p>
		<ul>
			<li>
	...
	<div id="data">
		<h2>Request Data</h2>
		<p>
			See the <code>com.softtek.samples.mvc.data</code> package for the @Controller code
		</p>
		<ul>
			<li>
	...
	<div id="responses">
		...
		<p>
			See the <code>com.softtek.samples.mvc.response</code> package for the @Controller code
		</p>		
		<ul>
			<li>
	...
	<div id="messageconverters">
		...
		<p>
			See the <code>com.softtek.samples.mvc.messageconverters</code> package for the @Controller code
		</p>	
	...
	<div id="views">
		...
		<p>
			See the <code>com.softtek.samples.mvc.views</code> package for the @Controller code
		</p>
		<ul>
			<li>
	...
	<div id="validation">
		<h2>Validation</h2>
		<p>
			See the <code>com.softtek.samples.mvc.validation</code> package for the @Controller code	
		</p>
		<ul>
			<li>
	...
	<div id="exceptions">
		...
		<p>
			See the <code>com.softtek.samples.mvc.exceptions</code> package for the @Controller code	
		</p>
		<ul>
			<li>
